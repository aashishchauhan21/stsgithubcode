...
public class CustomerAccount {
	...
	@NotNull(message = "Account no can not be blank. Please specify account no in payload.")
	private String acctNo;
	@NotEmpty(message = "Account type can not be blank. Please specify account type in payload.")
	@NotNull(message = "Account type can not be blank. Please specify account type in payload.")
	private String acctType;
	@NotEmpty(message = "Customer Name can not be blank. Please specify customer name in payload.")
	@NotNull(message = "Customer Name can not be blank. Please specify customer name in payload.")
	private String custName;
	@NotEmpty(message = "City can not be blank. Please specify City in payload.")
	@NotNull(message = "City can not be blank. Please specify City in payload.")
	private String city;
	@NotEmpty(message = "State can not be blank. Please specify state in payload.")
	@NotNull(message = "State can not be blank. Please specify state in payload.")
	private String state;
	@NotEmpty(message = "Country can not be blank. Please specify country in payload.")
	@NotNull(message = "Country can not be blank. Please specify country in payload.")
